...
public class ReservationControllerTest {
    ...
    private static final String OBJECT_DELETED_TEMPLATE = "Reservation %d has been deleted";
    private static final String REST_API_BASE = "/reservation";
    ...
    public void save() throws Exception {
        // Arrange
        var object = new Reservation(1, "", new Account(), new Date(System.currentTimeMillis()), new Flight());
    ...
    public void getAll() throws Exception {
        // Arrange
        var object1 = new Reservation(1, "", new Account(), new Date(System.currentTimeMillis()), new Flight());
        var object2 = new Reservation(2, "", new Account(), new Date(System.currentTimeMillis()), new Flight());
