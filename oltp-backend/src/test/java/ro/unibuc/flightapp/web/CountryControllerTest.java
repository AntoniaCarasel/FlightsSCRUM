...
public class CountryControllerTest {
    ...
    private static final String OBJECT_DELETED_TEMPLATE = "Country %d has been deleted";
    private static final String REST_API_BASE = "/country";
    ...
    public void getAll() throws Exception {
        // Arrange
        var object1 = new Country(1, "name");
        var object2 = new Country(2, "name");
