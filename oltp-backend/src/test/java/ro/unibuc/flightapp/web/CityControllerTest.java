...
public class CityControllerTest {
    ...
    private static final String OBJECT_DELETED_TEMPLATE = "City %d has been deleted";
    private static final String REST_API_BASE = "/city";
    ...
    public void save() throws Exception {
        // Arrange
        var object = new City(1, "", new Country());
    ...
    public void getAll() throws Exception {
        // Arrange
        var object1 = new City(1, "", new Country());
        var object2 = new City(1, "", new Country());
