...
public class ClientControllerTest {
    ...
    private static final String OBJECT_DELETED_TEMPLATE = "Client %d has been deleted";
    private static final String REST_API_BASE = "/client";
    ...
    public void save() throws Exception {
        // Arrange
        var object = new Client(1, "", "", "", new Country());
    ...
    public void getAll() throws Exception {
        // Arrange
        var object1 = new Client(1, "", "", "", new Country());
        var object2 = new Client(2, "", "", "", new Country());
